  ...
  return (
    <div className={style.footerContainer}>
      <div className={style.blockFooter}>
        <div className={style.blockFooterTitle}>
          О компании
        </div>
        <div className={style.blockFooterContent}>
          <div className={style.blockFooterContentText}>
            <a href={'/'} target={'_blank'} rel="noreferrer">Партнёрская программа</a>
            <a href={'/'} target={'_blank'} rel="noreferrer">Вакансии</a>
          </div>
        </div>
      </div>
      <div className={style.blockFooter}>
        ...
        <div className={style.blockFooterContent}>
          <div className={style.blockFooterContentText}>
            <a href={'/'} target={'_blank'} rel="noreferrer">Расчёт стоимости</a>
            <a href={'/'} target={'_blank'} rel="noreferrer">Услуги</a>
            <a href={'/'} target={'_blank'} rel="noreferrer">Виджеты</a>
            <a href={'/'} target={'_blank'} rel="noreferrer">Интеграции</a>
            <a href={'/'} target={'_blank'} rel="noreferrer">Наши клиенты</a>
          </div>
          <div className={style.blockFooterContentText}>
            <a href={'/'} target={'_blank'} rel="noreferrer">Кейсы</a>
            <a href={'/'} target={'_blank'} rel="noreferrer">Благодарственные письма</a>
            <a href={'/'} target={'_blank'} rel="noreferrer">Сертификаты</a>
            <a href={'/'} target={'_blank'} rel="noreferrer">Блог на Youtube</a>
            <a href={'/'} target={'_blank'} rel="noreferrer">Вопрос / Ответ</a>
          </div>
        </div>
      </div>
      <div className={style.blockFooter + ' ' + style.blockFooterContacts}>
        <div className={style.blockFooterTitle}>
          Контакты
        </div>
        <div className={style.blockFooterContent}>
          <div className={style.blockFooterContentText + ' ' + style.blockFooterContentTextContacts}>
            <div className={style.footerNumberPhone}>+7 555 555-55-55</div>
            <div className={style.footerSvgRow}>
              <a href={'https://telegram.org/'} target={'_blank'} rel="noreferrer" >
                <svg className={style.footerSvgRowItem} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href={'https://www.viber.com/ru/'} target={'_blank'} rel="noreferrer" >
                <svg className={style.footerSvgRowItem} width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={style.footerAddress}>Москва, Путевой проезд 3с1, к 902</div>
          </div>
        </div>
        <div className={style.privatePolicy}>
          <a href={'/'} target={'_blank'} rel="noreferrer" className={style.privatePolicyText}>
