...
import Services from "./Header/Navigation/Services/Services";
import Widgets from "./Header/Navigation/Widgets/Widgets";
import Integrations from "./Header/Navigation/Integrations/Integrations";
import Cases from "./Header/Navigation/Cases/Cases";
import Certificates from "./Header/Navigation/Certificates/Certificates";
    ...
    <BrowserRouter>
      <div className="App">
        ...
        <div>
            ...
            <svg width="117" height="117" viewBox="0 0 117 117" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <filter id="filter0_bd_0_13" x="0" y="0" width="117" height="117" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                  ...
                  <feGaussianBlur result="blurOut" in="offOut" stdDeviation="13.5"/>
                  ...
                  <feBlend mode="normal" in="SourceGraphic" in2="floodFill" result="shape"/>
                </filter>
          ...
          <div className='purpleBallMobile'>
